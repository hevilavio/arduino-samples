...
int sensor = 0; // Porta analogica que o sensor est ligado
int valorSensor = 0; // Porta analogica que o sensor est ligado
...
void setup()
{
  ...
  lcd.print("Luminosidade:"); //Escreve no LCD "LabdeGaragem"
